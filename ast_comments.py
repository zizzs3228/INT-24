...
def parse(source: typing.Union[str, bytes, ast.AST], *args, **kwargs) -> ast.AST:
...
def _enrich(source: typing.Union[str, bytes], tree: ast.AST) -> None:
...
def _get_tree_intervals(
    node: ast.AST,
) -> typing.Dict[typing.Tuple[int, int], typing.Dict[str, typing.Union[typing.List[typing.Tuple[int, int]], ast.AST]]]:
    res = {}
...
def _get_interval(items: typing.List[ast.AST]) -> typing.Tuple[int, int]:
    linenos, end_linenos = [], []
    for item in items:
